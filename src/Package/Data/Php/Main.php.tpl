...
{{$variable.private = Package.Difference.Fun.Account:Php:php.variable.define($variable.private, 'private')}}
{{implode("\n", $variable.private)}}
{{/if}}
{{if($variable.protected)}}

{{$variable.protected = Package.Difference.Fun.Account:Php:php.variable.define($variable.protected, 'protected')}}
{{implode("\n", $variable.protected)}}
{{/if}}
{{if($variable.public)}}

{{$variable.public = Package.Difference.Fun.Account:Php:php.variable.define($variable.public, 'public')}}
{{implode("\n", $variable.public)}}
{{/if}}
{{if($function)}}

{{$function = Package.Difference.Fun.Account:Php:php.function.define($function)}}
{{implode("\n", $function)}}
{{/if}}
